...
const Categories = () => {
  ...
  const fetchCategory = async () => {
    const url = BaseUrl() + `/api/admin/restaurant/${params.id}/categories`;
    try {
  ...
  const deleteCategory = async (_id) => {
    const url = BaseUrl() + `/categories/delete/category/${_id}`;
        ...
        >
          <div className="bg-slate-100 overflow-y-auto  lg:w-3/6  md:w-4/6 w-5/6 mx-auto  rounded-lg">
            ...
            >
              ...
              <button
                type="submit"
                className="bg-[rgb(240,72,88)] flex items-center justify-center cursor-pointer w-40 hover:bg-[rgb(240,72,88)] py-1 rounded-full"
              >
                {addCat ? (
