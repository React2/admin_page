  ...
  const fetchData = async () => {
    ...
    try {
      const { data } = await axios.get(
        "https://jatin-tagra-backend.vercel.app/api/v1/admin/getcancelReturnOrder",
        Auth
      );
      setData(data.data);
    ...
    <>
      ...
      <section>
        ...
        >
          ...
          >
            All Cancel Returned Orders ( Total : {total} )
          </span>
        </div>
...
export default HOC(CancelOrder);
