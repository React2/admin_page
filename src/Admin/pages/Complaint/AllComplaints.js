  ...
  const fetchData = async () => {
    ...
    try {
      const { data } = await axios.get(
        "https://jatin-tagra-backend.vercel.app/api/v1/admin/allComplaint",
        Auth
      );
      setData(data.data);
                  ...
                  <tbody>
                    {filterData?.map((i, index) => (
                      <tr key={index}>
                        ...
                        <td style={{ paddingLeft: "30px" }}>{i.reason} </td>
                        {/* <td style={{ paddingLeft: "30px" }}>
                          Longitude: {i.currentLocation.coordinates[0]}
                          <br />
                          Latitude: {i.currentLocation.coordinates[1]}
                        </td> */}
...
export default HOC(AllComplaint);
